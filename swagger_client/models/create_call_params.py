...
class CreateCallParams(object):
    ...
    def __init__(self, caller_phone_number=None, caller_extension=None, caller_caller_id=None, caller_private=None, callee_phone_number=None, callee_extension=None, callee_caller_id=None, callee_private=None):
        ...
        self._caller_extension = None
        self._caller_caller_id = None
        self._caller_private = None
        self._callee_phone_number = None
        self._callee_extension = None
        self._callee_caller_id = None
        self._callee_private = None

        if caller_phone_number is not None:
          self.caller_phone_number = caller_phone_number
        if caller_extension is not None:
          self.caller_extension = caller_extension
        if caller_caller_id is not None:
          self.caller_caller_id = caller_caller_id
        if caller_private is not None:
          self.caller_private = caller_private
        if callee_phone_number is not None:
          self.callee_phone_number = callee_phone_number
        if callee_extension is not None:
          self.callee_extension = callee_extension
        if callee_caller_id is not None:
          self.callee_caller_id = callee_caller_id
        if callee_private is not None:
          self.callee_private = callee_private
